...
//   ]);
//   const [input, setInput] = useState(""); // Single input field for both query & fee range
//   const messagesEndRef = useRef(null);

//   const sendMessage = async () => {
//     if (input.trim()) {
//       // Extract fee range if provided
//       const feeRegex = /fee:\s*(\d+\s*-\s*\d+)/i;
//       const feeMatch = input.match(feeRegex);
//       const extractedFeeRange = feeMatch ? feeMatch[1] : "";

//       // Remove fee part from input query
...
//                         {hospital["Website"] ? <a href={hospital["Website"]} target="_blank"> Visit</a> : "Not Available"}
//                       </p>
//                     </div>
//                   ))}
//                 </div>
